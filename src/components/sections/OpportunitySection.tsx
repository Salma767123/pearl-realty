...
const opportunities = [
  {
    ...
    stat: "+4,500",
    statLabel: "Net HNWI Inflow",
    description: "The world's largest migration of private wealth, driven by a global shift toward stability and tax optimization.",
  ...
  },
  {
    ...
    title: "Ultra-Prime Expansion",
    stat: "+43%",
    statLabel: "YoY Segment Growth",
    description: "The $5M+ residential segment continues to outperform global benchmarks, underpinned by genuine utility and wealth migration.",
    link: "/opportunity/market-growth",
  ...
  },
  {
    ...
    stat: "68%",
    statLabel: "Buyer Intent",
    description: "A profound shift in buyer sentiment, with a majority of global UHNWIs actively planning landmark Dubai acquisitions.",
    link: "/opportunity/uhnwi-behavior",
    color: "from-gold/10"
  },
  {
    id: "timing-advantage",
    ...
    stat: "$144B",
    statLabel: "Total Market Volume",
    description: "Historical transaction volumes meeting a structural crunch in ultra-prime supply creates a high-conviction entry point.",
    link: "/opportunity/timing-advantage",
