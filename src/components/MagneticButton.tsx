...
const MagneticButton = ({ 
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`relative z-20 group font-body text-xs tracking-[0.3em] uppercase px-10 py-5 font-semibold transition-all duration-300 ease-out overflow-hidden cursor-pointer pointer-events-auto hover:-translate-y-[2px] hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed ${
        primary
